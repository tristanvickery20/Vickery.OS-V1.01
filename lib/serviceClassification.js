...
const CLASSIFICATIONS = {
  ...
  EV_CHARGER: {
    ...
    photoGate:       true,
    photoGateModule: "PANEL_PHOTO",
    photoGatePrompt: "We need a photo of your electrical panel and the charger location before we can give you an accurate price. Open the panel door so the breakers are visible.",
  },
