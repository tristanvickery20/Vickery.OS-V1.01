...
const CLASSIFICATIONS = {
  ...
  DEDICATED_CIRCUIT: {
    ...
    photoGatePrompt:  "A photo of your electrical panel with the door open helps us confirm available breaker space and plan the new dedicated circuit before we arrive.",
    photoGatePrompts: {
      PANEL_PHOTO: "Open the panel door so all breakers are visible. We need to confirm there is available space and your panel can support the new circuit load.",
    },
  },
  ...
  SUBPANEL_INSTALL: {
    ...
    photoGate:        true,
    photoGateModules: ["PANEL_PHOTO", "WORK_AREA_PHOTO"],
    photoGatePrompt:  "Two photos help us prepare your subpanel estimate: your main panel and the planned subpanel location.",
    photoGatePrompts: {
      ...
      WORK_AREA_PHOTO: "Photograph the wall or area where the new subpanel will be installed — include nearby outlets, conduit, or junction boxes. This helps us plan the feeder run before the visit.",
    },
  },
  FUSE_BOX_CONVERSION: {
    status:          "MANUAL_QUOTE_ONLY",
  ...
  HOT_TUB_CIRCUIT: {
    ...
    photoGate:        true,
    photoGateModules: ["PANEL_PHOTO", "WORK_AREA_PHOTO"],
    photoGatePrompt:  "Two photos help us prepare your hot tub circuit estimate: your electrical panel and the tub location.",
    photoGatePrompts: {
      PANEL_PHOTO:     "Open the panel door so all breakers are visible. We need to confirm available capacity and space for a 240V dedicated circuit.",
      WORK_AREA_PHOTO: "Photograph the hot tub pad or installation area and the path between it and your electrical panel — show distance, any obstacles, and the wall or fence the conduit would run along.",
    },
  },
  SMOKE_CO_DETECTOR: {
    status:          "READY_WITH_REVIEW_FLAG",
    ...
    photoGate:        true,
    photoGateModules: ["CEILING_PHOTO"],
    photoGatePrompt:  "A photo of the ceiling where detectors will mount helps us confirm the ceiling height and mounting conditions before we arrive.",
    photoGatePrompts: {
      CEILING_PHOTO: "Look up at the ceiling location where a detector will go. Photograph the full ceiling surface showing any existing fixtures, beams, or vaulted angles — plus a clear view of the ceiling height. This helps us confirm mounting hardware and spacing before the visit.",
    },
  },
  APPLIANCE_CIRCUIT: {
    status:          "MANUAL_QUOTE_ONLY",
