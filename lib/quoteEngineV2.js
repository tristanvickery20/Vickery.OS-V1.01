 ...
 * @returns {object}                 — same keys as calculateQuote()
 */
function calculateQuoteV2({ assembly, qty, selectedDriverOptions, v2Data, serviceAreas, zip }) {
  ...
  const wastePct      = n(v2Config.materialWastePct || "0.05");
