...
// - CRM sheet (CRM_SHEET_ID): Leads (self-contained), ops, scheduling, config
// - Estimator sheet (ESTIMATOR_V2_SHEET_ID): Assemblies, pricing, ServiceAreas
// - HR sheet (HR_SHEET_ID): Staff, Techs, all HR_* tabs
//
// Dead tabs removed from CRM (can be deleted from live sheet):
//   Clients, Properties, Requests, Jobs, Bookings, ServiceAreas,
//   Actuals_Rollup_30D, Time (dup of TimeEntries), Staff (moved to HR),
//   Techs (moved to HR), all 31 HR_* tabs that were copied to CRM
