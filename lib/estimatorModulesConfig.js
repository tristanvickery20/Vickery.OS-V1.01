...
// Old seed had 20 modules / 25 services; new comprehensive seed has 50+ / 34+.
// Bump SEED_SERVICE_MIN each time modules_csv changes to force a re-seed on next boot.
// Last bumped: question-audit pass 1 (services 1–34 cleaned; SEED_SERVICE_MIN → 31).
const SEED_MODULE_MIN  = 35;
const SEED_SERVICE_MIN = 31;
