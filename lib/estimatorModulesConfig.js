...
// Loads Estimator_Modules + Estimator_ServiceMatrix from Google Sheets.
...
async function ensureAndSeed(sheets) {
  await ensureTabHeaders("Estimator_Modules");
  await ensureTabHeaders("Estimator_ServiceMatrix");
...
module.exports = { getEstimatorConfig, invalidateEstimatorCache };
