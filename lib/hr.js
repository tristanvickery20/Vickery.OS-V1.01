...
//
// Staff and Techs tabs now live on HR_SHEET_ID (moved from CRM_SHEET_ID 2026-05-11).
...
// ── Employee profile read/update (HR sheet) ────────────────────────────────────
...
// ── Append a full employee row (HR sheet) ──────────────────────────────────────
