...
const SERVICES = [
...

  {
    ...
    // A010 — 10 diagnostic questions: symptom, age, property, brand, space, amperage, exposure, photo
    modules_csv:  "UNSAFE_SYMPTOMS,HOME_AGE,PROPERTY_TYPE,PANEL_BRAND,PANEL_SPACE,PANEL_AMPERAGE,EXTERIOR_EXPOSURE,ROOM_LOCATION,PANEL_PHOTO,WORK_AREA_PHOTO",
...

  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A022 — 10 diagnostic questions: symptoms, circuit, brand, space, amperage, age, exposure, photo
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,PANEL_BRAND,PANEL_SPACE,PANEL_AMPERAGE,HOME_AGE,EXTERIOR_EXPOSURE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A015 — 10 questions per spec: sq ft, age, occupied, walls open,
    // wiring type, panel, attic/crawl, bedrooms, layout, photos
    modules_csv:  "SERVICE_QUANTITY,PROPERTY_TYPE,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PANEL_BRAND,PANEL_AMPERAGE,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A016 — 10q: area, unsafe, reason, walls, device count, access, wiring type, distance, panel photo, work area
    modules_csv:  "ROOM_LOCATION,UNSAFE_SYMPTOMS,REPLACE_OR_NEW,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,EXISTING_WIRING,DISTANCE_FROM_PANEL,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,PANEL_AMPERAGE,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A019 — 10 questions: reason, current/desired amps, location, meter proximity,
    // service type, brand, aluminum wiring, unsafe symptoms, photos
    modules_csv:  "UNSAFE_SYMPTOMS,PANEL_BRAND,PANEL_AMPERAGE,VOLTAGE_AMPERAGE,PROPERTY_TYPE,HOME_AGE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A020 — 10 questions: reason, location, distance, capacity, trenching,
    // loads, main panel space, mounting surface, permit, photos
    modules_csv:  "LOAD_TYPE,ROOM_LOCATION,DISTANCE_FROM_PANEL,VOLTAGE_AMPERAGE,TRENCHING_NEEDED,PANEL_SPACE,SURFACE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A021 — 10 questions: fuse confirmation, reason, home age, service type,
    // current size, knob-and-tube, location, active problems, walls, photos
    modules_csv:  "HOME_AGE,UNSAFE_SYMPTOMS,PANEL_AMPERAGE,PANEL_BRAND,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A023 — 10 questions: symptoms, circuit, brand, age, space, amperage, exposure, permit, panel photo, work area
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,PANEL_BRAND,HOME_AGE,PANEL_SPACE,PANEL_AMPERAGE,EXTERIOR_EXPOSURE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A024 — 10 questions: space, brand, symptoms, location, age, amperage, exposure, permit, panel photo, buffer
    modules_csv:  "PANEL_SPACE,PANEL_BRAND,UNSAFE_SYMPTOMS,ROOM_LOCATION,HOME_AGE,PANEL_AMPERAGE,EXTERIOR_EXPOSURE,PERMIT_NEEDED,PANEL_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    // A028 — 14 questions per spec; collect full panel info before booking
    modules_csv:  "REPLACE_OR_NEW,CUSTOMER_SUPPLIED_MATERIAL,ROOM_LOCATION,DISTANCE_FROM_PANEL,PANEL_AMPERAGE,PANEL_SPACE,PANEL_BRAND,VOLTAGE_AMPERAGE,CONDUIT_REQUIRED,TRENCHING_NEEDED,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A017 — 10 questions: purpose, voltage, amperage, panel distance, route,
    // wall type, panel full, home age, equipment status, photo
    modules_csv:  "LOAD_TYPE,VOLTAGE_AMPERAGE,DISTANCE_FROM_PANEL,ROUTE_TYPE,WALL_TYPE,PANEL_SPACE,PANEL_BRAND,HOME_AGE,PERMIT_NEEDED,PANEL_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A025 — 10 questions: appliance, replace/new, voltage/amps, location,
    // distance, appliance on site, cord/hardwire, panel full, finished wall path, photo
  ...
  },
  {
    ...
    modules_csv:  "CUSTOMER_SUPPLIED_MATERIAL,VOLTAGE_AMPERAGE,DISTANCE_FROM_PANEL,TRENCHING_NEEDED,PANEL_SPACE,PANEL_BRAND,ROUTE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "CUSTOMER_SUPPLIED_MATERIAL,LOAD_TYPE,PANEL_AMPERAGE,PANEL_SPACE,DISTANCE_FROM_PANEL,TRENCHING_NEEDED,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "PRODUCT_TYPE,PANEL_BRAND,PANEL_SPACE,PANEL_AMPERAGE,DISTANCE_FROM_PANEL,ROOM_LOCATION,VOLTAGE_AMPERAGE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "LOAD_TYPE,CUSTOMER_SUPPLIED_MATERIAL,PANEL_AMPERAGE,PANEL_SPACE,DISTANCE_FROM_PANEL,ROOM_LOCATION,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PANEL_BRAND,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,ROOM_LOCATION,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
  ...
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,VOLTAGE_AMPERAGE,ROOM_LOCATION,SURFACE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "placeholder",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,REPLACE_OR_NEW,ROOM_LOCATION,PERMIT_NEEDED,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "SERVICE_QUANTITY,CEILING_HEIGHT,REPLACE_OR_NEW,HOME_AGE,ROOM_LOCATION,WORK_AREA_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "SERVICE_QUANTITY,CEILING_HEIGHT,REPLACE_OR_NEW,ROOM_LOCATION,EXISTING_WIRING,PERMIT_NEEDED,WORK_AREA_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A001 — 10 questions: qty, replace/new, room, attic access, ceiling height,
    // ceiling surface type, control type, existing wiring at location, ceiling photo, buffer
    modules_csv:  "SERVICE_QUANTITY,REPLACE_OR_NEW,ROOM_LOCATION,ATTIC_ACCESS,CEILING_HEIGHT,SURFACE_TYPE,CONTROL_TYPE,EXISTING_WIRING,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A003 — 10 questions: fixture type, existing wiring, purchased, weight,
    // ceiling height, box condition, room, assembly, dimmer/switch, photo
    modules_csv:  "PRODUCT_TYPE,EXISTING_WIRING,CUSTOMER_SUPPLIED_MATERIAL,FIXTURE_WEIGHT,CEILING_HEIGHT,EXISTING_BOX,ROOM_LOCATION,HOME_AGE,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A007 — 10 questions: what retrofitting, qty, working status, old bulb type,
    // ceiling height, access clear, color temp, ballast bypass, damp, photo
    modules_csv:  "PRODUCT_TYPE,SERVICE_QUANTITY,CEILING_HEIGHT,ATTIC_ACCESS,EXTERIOR_EXPOSURE,REPLACE_OR_NEW,HOME_AGE,ROOM_LOCATION,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A004 — 10 questions: existing fan/light, fan-rated box, ceiling height,
    // above-ceiling access, fan size, purchased, control type, separate fan/light,
    // indoor/damp/outdoor, photo
    modules_csv:  "EXISTING_WIRING,FAN_RATED_BOX,CEILING_HEIGHT,ATTIC_ACCESS,SERVICE_QUANTITY,CUSTOMER_SUPPLIED_MATERIAL,CONTROL_TYPE,THREE_WAY_SWITCHING,EXTERIOR_EXPOSURE,CEILING_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A005 — 10 questions: type, replace/new, location, surface, mounting height,
    // switch available, rain exposed, trenching, controls, photo
    modules_csv:  "PRODUCT_TYPE,REPLACE_OR_NEW,ROOM_LOCATION,SURFACE_TYPE,CEILING_HEIGHT,EXISTING_WIRING,EXTERIOR_EXPOSURE,TRENCHING_NEEDED,HOME_AGE,OUTDOOR_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A006 — 10 questions: replace/new, light type, customer-supplied,
    // mounting height, surface, existing power, switch, Wi-Fi, rain exposed, photo
    modules_csv:  "REPLACE_OR_NEW,PRODUCT_TYPE,CUSTOMER_SUPPLIED_MATERIAL,CEILING_HEIGHT,SURFACE_TYPE,EXISTING_WIRING,CONTROL_TYPE,WIFI_AVAILABLE,EXTERIOR_EXPOSURE,OUTDOOR_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A011 — 10 questions: replace/new, qty, location, wall type, nearby outlet,
    // insulation/crawl, load type, outlet type, home age, photo
    modules_csv:  "REPLACE_OR_NEW,SERVICE_QUANTITY,ROOM_LOCATION,WALL_TYPE,EXISTING_WIRING,CRAWLSPACE_ACCESS,LOAD_TYPE,PRODUCT_TYPE,HOME_AGE,OUTLET_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A012 — 10 questions: replace/new, location, qty, working status,
    // existing GFCI, damp/exterior, ground, box condition, home age, photo
    modules_csv:  "REPLACE_OR_NEW,ROOM_LOCATION,SERVICE_QUANTITY,EXISTING_WIRING,EXTERIOR_EXPOSURE,EXISTING_BOX,UNSAFE_SYMPTOMS,WALL_TYPE,HOME_AGE,OUTLET_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A008 — 10 questions: replace/new, what it controls, switches in box,
    // 3-way, bulb type (load), customer-supplied, neutral wire, wall type,
    // unsafe symptoms, photo
    modules_csv:  "REPLACE_OR_NEW,LOAD_TYPE,SERVICE_QUANTITY,THREE_WAY_SWITCHING,CUSTOMER_SUPPLIED_MATERIAL,NEUTRAL_PRESENT,WALL_TYPE,UNSAFE_SYMPTOMS,HOME_AGE,SWITCH_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A014 — 10 questions: brand, load type, 3-way, neutral wire, switches
    // in box, Wi-Fi, app setup wanted, wall type, home age, photo
    modules_csv:  "PRODUCT_TYPE,LOAD_TYPE,THREE_WAY_SWITCHING,NEUTRAL_PRESENT,SERVICE_QUANTITY,WIFI_AVAILABLE,SMART_PLATFORM,WALL_TYPE,HOME_AGE,SWITCH_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A030 — 10 questions: smoke/CO/combo type, qty, replace/new, ceiling height, attic,
    // product preference, home age, room, ceiling photo (mounting context), uncertainty
