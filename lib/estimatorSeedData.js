...
const SERVICES = [
  ...
  },
  {
    ...
    // Panel space + distance + conduit are the dominant cost drivers.
    // PANEL_PHOTO is required (photo gate) before price is shown.
    modules_csv:  "HOME_AGE,PANEL_SPACE,PANEL_PHOTO,DISTANCE_FROM_PANEL,WORK_AREA_PHOTOS,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
