...
const SERVICES = [
  ...
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A016 — area, reason, walls open, device count, circuit, distance, access, wiring type
    modules_csv:  "ROOM_LOCATION,REPLACE_OR_NEW,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,DISTANCE_FROM_PANEL,PANEL_PHOTO,WORK_AREA_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  },
  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A024 — 10 questions: scope, brand, panel full, location, tier, sensitive
    // equipment, storm history, grounding, home age, photo
