...
const SERVICES = [
...

  {
    ...
    // PANEL_BRAND catches FPE/Zinsco. UNSAFE_SYMPTOMS routes emergencies.
    modules_csv:  "PROPERTY_TYPE,HOME_AGE,UNSAFE_SYMPTOMS,PANEL_BRAND,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  },
  {
    ...
    // Panel space + brand + distance + conduit are the dominant cost drivers.
    // PANEL_PHOTO required gate. PANEL_BRAND catches FPE/Zinsco disqualifiers.
    modules_csv:  "HOME_AGE,PANEL_SPACE,PANEL_BRAND,PANEL_PHOTO,DISTANCE_FROM_PANEL,CONDUIT_REQUIRED,WORK_AREA_PHOTOS,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // Key drivers: existing wiring + box rating, ceiling height, attic access,
    // fixture weight, control type, 3-way, outdoor exposure.
    modules_csv:  "FAN_EXISTING_WIRING,CEILING_HEIGHT,ATTIC_ACCESS,FIXTURE_WEIGHT,FAN_CONTROL_TYPE,THREE_WAY_SWITCHING,OUTDOOR_EXPOSURE,HOME_AGE,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // Key drivers: existing box, circuit scope, ceiling height, fixture weight.
    // Room type provides routing context. CEILING_PHOTO is the photo gate.
    modules_csv:  "CIRCUIT_SCOPE,EXISTING_BOX,CEILING_HEIGHT,FIXTURE_WEIGHT,ROOM_TYPE,HOME_AGE,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    // Ceiling type and insulation affect can selection. Room adds routing context.
    modules_csv:  "ATTIC_ACCESS,CEILING_HEIGHT,CIRCUIT_SCOPE,ROOM_TYPE,HOME_AGE,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // Neutral wire and 3-way are the hidden cost drivers on dimmer swaps.
    // Unsafe symptoms trigger emergency flag before pricing.
    modules_csv:  "CIRCUIT_SCOPE,WALL_TYPE,THREE_WAY_SWITCHING,SMART_NEUTRAL_WIRE,UNSAFE_SYMPTOMS,HOME_AGE,SWITCH_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // Neutral wire presence is the #1 cost fork for smart devices.
    // 3-way doubles the device count. Wi-Fi and platform are qualifier questions.
    modules_csv:  "WALL_TYPE,SMART_NEUTRAL_WIRE,THREE_WAY_SWITCHING,SMART_PLATFORM,WIFI_AVAILABLE,HOME_AGE,SWITCH_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // Ceiling height and attic access drive LED retrofit labor just like recessed.
    // Fixture count matters for multi-fixture jobs.
    modules_csv:  "ATTIC_ACCESS,CEILING_HEIGHT,CIRCUIT_SCOPE,HOME_AGE,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    // Wall type + crawlspace + distance determine wire routing cost.
    modules_csv:  "CIRCUIT_SCOPE,WALL_TYPE,CRAWLSPACE_ACCESS,DISTANCE_FROM_PANEL,ROOM_TYPE,HOME_AGE,OUTLET_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // GFCI swap is one of the most predictable jobs. Room determines code req.
    // Unsafe symptoms catch active hazards before pricing.
    modules_csv:  "CIRCUIT_SCOPE,WALL_TYPE,ROOM_TYPE,UNSAFE_SYMPTOMS,HOME_AGE,OUTLET_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // Panel space and brand are the disqualifiers. Unsafe symptoms catch FPE/Zinsco issues.
    modules_csv:  "PANEL_SPACE,PANEL_BRAND,UNSAFE_SYMPTOMS,PANEL_PHOTO,HOME_AGE,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // Mounting surface disqualifies masonry. Circuit source is the main cost fork.
    // Weather exposure determines device and cover spec.
    modules_csv:  "OUTDOOR_MOUNTING,OUTDOOR_CIRCUIT,OUTDOOR_EXPOSURE,HOME_AGE,OUTDOOR_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // Like outdoor lighting but typically replacing existing — scope is tighter.
    modules_csv:  "OUTDOOR_MOUNTING,OUTDOOR_CIRCUIT,OUTDOOR_EXPOSURE,HOME_AGE,OUTDOOR_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
