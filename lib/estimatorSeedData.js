...
const SERVICES = [
...

  {
    ...
    // ceiling type, switch/dimmer, attic obstacles, trim, photo
    modules_csv:  "SERVICE_QUANTITY,REPLACE_OR_NEW,ROOM_LOCATION,ATTIC_ACCESS,CEILING_HEIGHT,WALL_TYPE,THREE_WAY_SWITCHING,HOME_AGE,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
