...
const SERVICES = [
...

  {
    ...
    // A010 — 10 diagnostic questions for flicker/tripping/dead circuits
    modules_csv:  "PROPERTY_TYPE,HOME_AGE,UNSAFE_SYMPTOMS,PANEL_BRAND,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
...

  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A022 — diagnostic, triage safety first, identify circuit and panel
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,HOME_AGE,PANEL_BRAND,PANEL_SPACE,PANEL_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "SERVICE_QUANTITY,PROPERTY_TYPE,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PANEL_BRAND,PANEL_AMPERAGE,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "ROOM_LOCATION,REPLACE_OR_NEW,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,DISTANCE_FROM_PANEL,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,PANEL_AMPERAGE,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,PANEL_BRAND,PANEL_AMPERAGE,VOLTAGE_AMPERAGE,PROPERTY_TYPE,HOME_AGE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "LOAD_TYPE,ROOM_LOCATION,DISTANCE_FROM_PANEL,VOLTAGE_AMPERAGE,TRENCHING_NEEDED,PANEL_SPACE,SURFACE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "HOME_AGE,UNSAFE_SYMPTOMS,PANEL_AMPERAGE,PANEL_BRAND,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "site_visit_required",
    // A023 — 10 questions: problem type, hot/smoking/sparking, circuit,
    // panel brand, breaker size, recent changes, indoor/outdoor, cover, home age, photo
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,PANEL_BRAND,HOME_AGE,PANEL_SPACE,EXTERIOR_EXPOSURE,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
...

  {
    ...
    modules_csv:  "REPLACE_OR_NEW,CUSTOMER_SUPPLIED_MATERIAL,ROOM_LOCATION,DISTANCE_FROM_PANEL,PANEL_AMPERAGE,PANEL_SPACE,PANEL_BRAND,VOLTAGE_AMPERAGE,CONDUIT_REQUIRED,TRENCHING_NEEDED,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  },
  {
    ...
    modules_csv:  "CUSTOMER_SUPPLIED_MATERIAL,VOLTAGE_AMPERAGE,DISTANCE_FROM_PANEL,TRENCHING_NEEDED,PANEL_SPACE,PANEL_BRAND,ROUTE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "CUSTOMER_SUPPLIED_MATERIAL,LOAD_TYPE,PANEL_AMPERAGE,PANEL_SPACE,DISTANCE_FROM_PANEL,TRENCHING_NEEDED,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "PRODUCT_TYPE,PANEL_BRAND,PANEL_SPACE,PANEL_AMPERAGE,DISTANCE_FROM_PANEL,ROOM_LOCATION,VOLTAGE_AMPERAGE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "LOAD_TYPE,CUSTOMER_SUPPLIED_MATERIAL,PANEL_AMPERAGE,PANEL_SPACE,DISTANCE_FROM_PANEL,ROOM_LOCATION,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,HOME_AGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PANEL_BRAND,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,ROOM_LOCATION,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS",
  ...
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,VOLTAGE_AMPERAGE,ROOM_LOCATION,SURFACE_TYPE,PERMIT_NEEDED,PANEL_PHOTO,WORK_AREA_PHOTOS",
    base_price_mode: "placeholder",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    modules_csv:  "PROPERTY_TYPE,CEILING_HEIGHT,SERVICE_QUANTITY,REPLACE_OR_NEW,ROOM_LOCATION,PERMIT_NEEDED,WORK_AREA_PHOTOS",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "SERVICE_QUANTITY,CEILING_HEIGHT,REPLACE_OR_NEW,HOME_AGE,ROOM_LOCATION,WORK_AREA_PHOTOS,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "SERVICE_QUANTITY,CEILING_HEIGHT,REPLACE_OR_NEW,ROOM_LOCATION,EXISTING_WIRING,PERMIT_NEEDED,WORK_AREA_PHOTOS,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A030 — 10 questions: battery/hardwired, qty, interconnected, issue,
    // ceiling height, existing/new locations, smoke/CO/combo, home age, attic, photo
