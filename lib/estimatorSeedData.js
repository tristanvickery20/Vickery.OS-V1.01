...
const SERVICES = [
...

  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,HOME_AGE,PANEL_BRAND,PANEL_PHOTO,WORK_AREA_PHOTO",
...

  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,PANEL_BRAND,PANEL_SPACE,PANEL_AMPERAGE,HOME_AGE,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  ...
  },
  {
    ...
    modules_csv:  "LOAD_TYPE,ROOM_LOCATION,DISTANCE_FROM_PANEL,VOLTAGE_AMPERAGE,TRENCHING_NEEDED,PANEL_SPACE,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,HOME_AGE,PANEL_BRAND,PANEL_AMPERAGE,ATTIC_ACCESS,CRAWLSPACE_ACCESS,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "UNSAFE_SYMPTOMS,ROOM_LOCATION,PANEL_BRAND,HOME_AGE,PANEL_SPACE,PANEL_AMPERAGE,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    modules_csv:  "PANEL_SPACE,PANEL_BRAND,UNSAFE_SYMPTOMS,HOME_AGE,PANEL_AMPERAGE,PANEL_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  ...
  },
  {
    ...
    segment:      "commercial",
    tier:         "site_visit_required",
    // 7 questions: ceiling height (ladder driver), replace vs new, scope, building age, existing wiring type, photos
    modules_csv:  "CEILING_HEIGHT,REPLACE_OR_NEW,ROOM_LOCATION,HOME_AGE,EXISTING_WIRING,PANEL_PHOTO,WORK_AREA_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "CEILING_HEIGHT,REPLACE_OR_NEW,HOME_AGE,ROOM_LOCATION,WORK_AREA_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "commercial",
    tier:         "instant_with_safeguards",
    modules_csv:  "CEILING_HEIGHT,REPLACE_OR_NEW,ROOM_LOCATION,EXISTING_WIRING,WORK_AREA_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A001 — 9 questions: price fork first (replace vs new), then access (attic is biggest driver),
    // ceiling height + surface (labor), controls, wiring, room, photo, buffer
    modules_csv:  "REPLACE_OR_NEW,ATTIC_ACCESS,CEILING_HEIGHT,SURFACE_TYPE,CONTROL_TYPE,EXISTING_WIRING,ROOM_LOCATION,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A007 — 9 questions: what type of retrofit (price fork), height + access (labor driver),
    // wet/outdoor exposure, working vs not, age (ballast type), room, photo, uncertainty
    modules_csv:  "PRODUCT_TYPE,CEILING_HEIGHT,ATTIC_ACCESS,EXTERIOR_EXPOSURE,REPLACE_OR_NEW,HOME_AGE,ROOM_LOCATION,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A004 — 9 questions: existing power (requires new circuit?), box rated?, ceiling height + access (labor),
    // customer-supplied, controls, 3-way, outdoor/damp, photo
    modules_csv:  "EXISTING_WIRING,FAN_RATED_BOX,CEILING_HEIGHT,ATTIC_ACCESS,CUSTOMER_SUPPLIED_MATERIAL,CONTROL_TYPE,THREE_WAY_SWITCHING,EXTERIOR_EXPOSURE,CEILING_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A030 — 9 questions: detector type (smoke/CO/combo = price fork), replace vs new,
    // ceiling height + access (any hardwire run?), product pref, age (interconnect type), room, photo, buffer
    modules_csv:  "SMOKE_TYPE,REPLACE_OR_NEW,CEILING_HEIGHT,ATTIC_ACCESS,PRODUCT_TYPE,HOME_AGE,ROOM_LOCATION,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
];
