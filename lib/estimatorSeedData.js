...
const SERVICES = [
...

  {
    ...
    modules_csv:  "REPLACE_OR_NEW,ROOM_LOCATION,ATTIC_ACCESS,CEILING_HEIGHT,SURFACE_TYPE,CONTROL_TYPE,EXISTING_WIRING,CEILING_PHOTO,UNCERTAINTY_BUFFER",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A003 — questions: existing wiring (primary fork), fixture type, purchased, weight,
    // ceiling height, box condition, room, age, photo
    modules_csv:  "EXISTING_WIRING,PRODUCT_TYPE,CUSTOMER_SUPPLIED_MATERIAL,FIXTURE_WEIGHT,CEILING_HEIGHT,EXISTING_BOX,HOME_AGE,ROOM_LOCATION,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A005 — questions: replace/new (primary fork), fixture type, location, surface, height,
    // existing wiring, exposure, trenching, age, photo
    modules_csv:  "REPLACE_OR_NEW,PRODUCT_TYPE,ROOM_LOCATION,SURFACE_TYPE,CEILING_HEIGHT,EXISTING_WIRING,EXTERIOR_EXPOSURE,TRENCHING_NEEDED,HOME_AGE,OUTDOOR_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  // make the service row count = 35 so the stale-seed threshold (SEED_SERVICE_MIN=35)
