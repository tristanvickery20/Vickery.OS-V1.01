...
const SERVICES = [
  ...
  },
  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A007 — 9 questions: what type of retrofit (price fork), replace vs new run (2nd fork),
    // height + access (biggest labor drivers), wet/outdoor spec, age (ballast type), room, photo, buffer
    modules_csv:  "PRODUCT_TYPE,REPLACE_OR_NEW,CEILING_HEIGHT,ATTIC_ACCESS,EXTERIOR_EXPOSURE,HOME_AGE,ROOM_LOCATION,CEILING_PHOTO,CUSTOMER_UNSURE",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant",
    // A004 — 9 questions: existing power (new circuit?), box rated? (safety gate), ceiling height + access (labor),
    // outdoor/damp spec (before features), customer-supplied, controls, 3-way, photo
    modules_csv:  "EXISTING_WIRING,FAN_RATED_BOX,CEILING_HEIGHT,ATTIC_ACCESS,EXTERIOR_EXPOSURE,CUSTOMER_SUPPLIED_MATERIAL,CONTROL_TYPE,THREE_WAY_SWITCHING,CEILING_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
...

  {
    ...
    segment:      "residential",
    tier:         "instant_with_safeguards",
    // A005 — 9 questions: replace/new (primary fork), fixture type, location, surface, height,
    // existing wiring (new run?), trenching (if no power), age, photo
    // EXTERIOR_EXPOSURE removed — all fixtures on this service are outdoors by definition
    modules_csv:  "REPLACE_OR_NEW,PRODUCT_TYPE,ROOM_LOCATION,SURFACE_TYPE,CEILING_HEIGHT,EXISTING_WIRING,TRENCHING_NEEDED,HOME_AGE,OUTDOOR_PHOTO",
    base_price_mode: "existing_calculator",
    enabled: "TRUE",
  },
  {
  ...
  {
    service_id:   "_SEED_VER_20260512B",
