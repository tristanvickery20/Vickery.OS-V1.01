...
// Counts working days (Mon–Fri) between two dates inclusive, minus holidays.
// If half_day is true, validates that fromDate is a working day
// (Mon–Fri and not in the active holiday set). Returns 0.5 for valid
// working days, 0 if the date falls on a weekend or holiday.
...
// ── Staff leave_policy_id column migration ──────────────────────────────────────
