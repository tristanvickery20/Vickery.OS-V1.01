...
async function getQuoteConfig() {
  ...
  // No cache at all — throw so callers can return a proper 503.
  throw new Error("Quote config unavailable: sheets returned no job types (quota or connectivity issue). Please retry.");
}
